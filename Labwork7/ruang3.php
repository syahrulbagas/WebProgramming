...
id="navbarNavAltMarkup"> 
  ...
  <div class="col">
    <div class="card h-100">
      <iframe width="aut" height="400" src="https://www.youtube.com/embed/ayVUngaqz1Y" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
      <div class="card-body">
        <h5 class="card-title">Film Horor</h5>
        <p class="card-text">Film Bioskop Horor Indonesia Terbaru 2021 - Jangan Sendirian</p>
      </div>
    </div>
    <center>
    <div>
